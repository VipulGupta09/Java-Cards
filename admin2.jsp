...
<head>
  ...
  <meta charset="utf-8">
  <title>ATAT Consultancy Services - ID Card Portal</title>
...
window.open("temp_check.jsp",width="100",height="200");
</script>
<%}%>
		...
		<!-- Start: Header -->
        <header class="navbar">
        <a href="admin.jsp"><img src="assets/img/logos/acs-logo.png" height="25%" style="border-radius:0px !important; margin-top:22px; margin-left:22px;" draggable="false"></img></a>
            
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                	<a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown"> <img src="image/shubham.jpg" alt="avatar" class="mw30 br64 mr15"> Shubham Gupta
...
<%
	if((request.getParameter("generate")==null) || (request.getParameter("generate")=="")) { %> 
			...
			<!--<h2 style="margin-top:40px; line-height:25px;"> Send just about <b class="text-primary">Anything</b> to AdminDock</h2>
			<p class="lead">Give it a try below! Select a type of content and click "Send to Admin Dock".</p>-->
	...
	if((request.getParameter("msg")==null) || (request.getParameter("msg")=="")) { %>
                    ...
                    <form method="post" action="registration.jsp" id="admin-form">
						...
						<div class="panel-body bg-light" style="border-radius:0px;">
                        	...
                        	<b>Register New Employee <i class="fa fa-caret-right pr5 pl5"></i> <font color="#1d97fe">Basic Details</font></b><br><br>
							...
							<div class="section row">
                            	<div class="col-md-4">
                                	<label for="name" class="field prepend-icon">
                                    	<input type="text" name="name" id="name" class="gui-input" placeholder="Employee Name" autocomplete="off" style="border-radius:0px !important">
                            ...
                            <div class="section row">
                                ...
                                <div class="col-md-4">
                                	<label for="designation" class="field prepend-icon">
                                    	<input type="text" name="designation" id="designation" class="gui-input" placeholder="Designation" autocomplete="off" style="border-radius:0px !important">
                                ...
                                <div class="col-md-4">
                                	<label for="doj" class="field prepend-icon">
                                    	<input type="text" name="doj" id="datepicker2" class="gui-input" placeholder="Date of Joining" autocomplete="off" style="border-radius:0px !important">
		...
		<div class="dock-item" data-title="Admin Form">
			<div class="admin-form">
				<div class="panel">
               		...
               		<form method="get" action="blockcard.jsp" id="admin-form">
		...
		<div class="dock-item" data-title="Admin Form">
			<div class="admin-form">
				<div class="panel">
               		...
               		<form method="get" action="temporarycard.jsp" id="admin-form">
...
<!--CHECK STATUS END-->
                  ...
                  <!--<div id="dock-image" class="active-content">
                    <div class="dock-item" data-title="Tiger Image">
                      <img class="img-responsive center-block" src="../../../../farm9.staticflickr.com/8242/8558295633_f34a55c1c6_b.jpg">
                    </div>
                  </div>-->
            ...
            <div class="content-header">
                <center>
                    <font style="color:#555; font-weight:600;">&copy; ATAT Consultancy Services</font> | All Rights Reserved.
                </center>
            </div>
