              ...
              <div class="col-xs-12 col-sm-4 br-a br-light bg-light pv20 ph30 va-t">
                ...
                <div class="row" id="content-type">
                  ...
                  <div class="col-xs-4 col-sm-6">
                    <a class="holder-style p15 mb20" href="#add-money">
                      <span class="fa fa-print holder-icon"></span>
                      <br> Add Money
                    </a>
                  </div>
                  <div class="col-xs-4 col-sm-6">
                    <a class="holder-style p15 mb20" href="#purchase-form">
...
<!-<!--Canteen Form start-->
<div id="add-money" class="active-content">
    	<div class="dock-item" data-title="Admin Form">
        	<div class="admin-form">
            	<div class="panel">
				
				 <form method="post" action="canteenform.jsp" id="admin-form">

						<div class="panel-body bg-light" style="border-radius:0px;">
                        
                        	<b>Canteen Open 24*7 <i class="fa fa-caret-right pr5 pl5"></i> <font color="#1d97fe">Account Details</font></b><br><br>
							...
							<div class="section row">
                            	<div class="col-md-4">
                                	<label for="name" class="field prepend-icon">
                                    	<input type="text" name="stu_id" id="stu_id" class="gui-input" placeholder="Student ID" autocomplete="off" style="border-radius:0px !important">
								 ...
								 <div class="col-md-4">
                                	<label for="name" class="field prepend-icon">
                                    	<input type="text" name="ammount" id="ammount" class="gui-input" placeholder="amount" autocomplete="off" style="border-radius:0px !important">
                                        <label for="name" class="field-icon">
										<i class="fa fa-user"></i>
							...
							<div class="col-md-8 hidden-xs">
                                	<button type="submit" name="add_money" onClick="submit()" class="button btn-primary gui-input" style="border-radius:0px; margin-bottom:-20px;"> SUBMIT </button>
                                </div>
								 <div class="col-md-4">
                                	<%=request.getParameter("cmsg")%>
                                </div>
    	...
    	<div class="dock-item" data-title="Admin Form">
        	<div class="admin-form">
            	<div class="panel">
				 ...
				 <form method="post" action="Canteenform2.jsp" id="admin-form">
						...
						<div class="panel-body bg-light" style="border-radius:0px;">
							...
							<div class="section row">
								...
								<div class="col-md-4">
                                	<label for="name" class="field prepend-icon">
                                    	<input type="text" name="food_item" id="food_name" class="gui-input" placeholder="Food Item" autocomplete="off" style="border-radius:0px !important">
                                        <label for="name" class="field-icon">
                                        	<i class="fa fa-user"></i>
                                        </label>
                                    </label>
								 ...
								 <div class="col-md-4">
                                	<label for="name" class="field prepend-icon">
                                    	<input type="text" name="price" id="name" class="gui-input" placeholder="price" autocomplete="off" style="border-radius:0px !important">
                                        <label for="name" class="field-icon">
										<i class="fa fa-user"></i>
							...
							<div class="col-md-8 hidden-xs">
                                	<button type="submit" name="item_purchase" onClick="submit()" class="button btn-primary gui-input" style="border-radius:0px; margin-bottom:-20px;"> SUBMIT </button>
                                </div>
								 
							<div class="col-md-4">
                                	<input type="text" value="<%=request.getParameter("cmsg")%>">
                                </div>	
						</div>
					</form>
					<%
					if(request.getParameter("add-money")!=null)
					{
                   ...
                   PreparedStatement stml = con.prepareStatement("select * from login where emp_id=?");			
					...
					if(request.getParameter("item_purchase")!=null)
					{
